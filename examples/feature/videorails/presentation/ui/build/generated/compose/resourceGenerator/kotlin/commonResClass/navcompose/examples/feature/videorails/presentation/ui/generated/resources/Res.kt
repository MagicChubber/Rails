...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/navcompose.examples.feature.videorails.presentation.ui.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/navcompose.examples.feature.videorails.presentation.ui.generated.resources/" +
      path)
